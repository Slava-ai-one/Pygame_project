...
from scecond_charecter import  load_image_scecond
...
class Map:
    def __init__(self, filename, free_tiles, finish_tale):
        self.map = []
        self.curr_map = []
    ...
    def render(self, screen):
        colors = [(17, 20, 120), (2, 11, 92), (0, 0, 0)]
        h = 0
...
def main():
    ...
    labyrinth = Map('Описания.txt', [0, 2], 2)
